        ...
        <div className="grid lg:grid-cols-2 gap-10">
          <div>
            ...
            <div className="mt-6 space-y-3 text-white/80">
              <p><span className="text-white">Sales:</span> +923212022077</p>
              <p><span className="text-white">Support:</span> <a className="underline hover:text-white" href="mailto:support@whatsapp.sabtech.org">support@whatsapp.sabtech.org</a></p>
            </div>
          </div>
          <div className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xl ring-1 ring-white/10">
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={(e)=>e.preventDefault()}>
              ...
              <button type="submit" className="sm:col-span-2 h-11 rounded-xl font-semibold text-white bg-gradient-to-r from-cyan-400 to-blue-600">Send</button>
            </form>
          </div>
        </div>
        <div className="mt-16 text-white/60 text-sm">
          © {new Date().getFullYear()} WHATSAPP.SABTECH.ORG • <a className="underline hover:text-white" href="https://whatsapp.sabtech.org/refund-policy.php" target="_blank" rel="noopener noreferrer">Refund Policy</a>
        </div>
      </div>
    </section>
  )
